...
public class MyLinkedListIterator implements MyIterator {
    /* GỢI Ý: */
    /*
     * MyLinkedListIterator cần phải tham chiếu đến node hiện tại của MyLinkedList
     * để có thể duyệt qua
    ...
    /**
     * iterator dịch chuyển sang phần tử kế tiếp của MyLinkedList và trả ra dữ liệu
     * (payload) của phần tử hiện tại của MyLinkedList.
     * 
